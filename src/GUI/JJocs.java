...
public class JJocs extends JFrame implements ActionListener {
	private JLabel  jlJocs;
	...
	public JJocs() {
		...
		try {
			...
			getContentPane().setLayout(null);
				...
				jlJocs = new JLabel();
				getContentPane().add(jlJocs);
				jlJocs.setText("GESTIÓ DE JOCS");
				jlJocs.setBounds(12, 12, 279, 16);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("btnNou")) {
			JJocsNou inst = new JJocsNou(this,true);
