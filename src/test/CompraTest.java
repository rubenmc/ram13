...
public class CompraTest {
	...
	public static void main(String[] args) {
		...
		Date now = new Date();
		Particular algo = new Particular(0, "Nom del client", "977771562", "99988877A",
		...
		for(int x=0;x<articles.length;x++){
			...
			preu+=articles[x].getPreu();
		}
		
		Compra compra = new Compra(0, algo.getId(), empleat.getId(), articles, preu, now);
